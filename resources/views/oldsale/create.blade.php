...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('oldsale.store')}}" enctype="multipart/form-data">
        {{csrf_field()}}
        <div class="row">
      ...
      <p class="text-danger"><span class="font-weight-bold">**</span>Once you submitted book sale request, our representative will contact you and inspect the book. <br>After successfull inspection your book will be published for sale</p>
    </div>
</div>
