                ...
                <div class="col-lg-12 col-md-12 col-12">
                    ...
                    <div class="right-content">
                        ...
                        <li><i class="ti-location-pin"></i> <a href="{{route('order.track')}}">Track Order</a></li>
                            ...
                            @else
                                <li><i class="ti-power-off"></i><a href="/login">Login /</a> <a href="/register">Register</a></li>
                            @endauth
                        </ul>
                    </div>
                    <!-- End Top Right -->
            ...
            <div class="row">
                <div class="col-lg-2 col-md-2 col-12">
                    ...
                    <div class="logo">
                        ...
                        @endphp
                        <a href="{{route('home')}}"><img src="@foreach($settings as $data) {{asset('storage/'.$data->logo)}} @endforeach" alt="logo"></a>
                    </div>
                    <!--/ End Logo -->
                    <!-- Search Form -->
                                        ...
                                        {{-- {{Helper::getAllProductFromCart()}} --}}
                                            @foreach(Helper::getAllProductFromWishlist() as $data)
                                                    <li>
                                                        ...
                                                        <a class="cart-img" href="#"><img src="{{asset('storage/'.$data->product['photo'])}}"></a>
                                        ...
                                        {{-- {{Helper::getAllProductFromCart()}} --}}
                                            @foreach(Helper::getAllProductFromCart() as $data)
                                                    <li>
                                                        ...
                                                        <a class="cart-img" href="#"><img src="{{asset('storage/'.$data->product['photo'])}}" alt=""></a>
                                                        <h4><a href="{{route('product-detail',$data->product['slug'])}}" target="_blank">{{$data->product['title']}}</a></h4>
                                                        <p class="quantity">{{$data->quantity}} x - <span class="amount">৳{{number_format($data->price,2)}}</span></p>
                                                    </li>
                                            @endforeach
